...
const ALLOWED: Readonly<Record<PaymentState, readonly PaymentState[]>> = {
  CREATED: ['REQUIRES_PAYMENT_METHOD', 'AUTHORIZING', 'CANCELED'],
  REQUIRES_PAYMENT_METHOD: ['AUTHORIZING', 'CANCELED'],
  AUTHORIZING: [
  ...
  REQUIRES_ACTION: ['AUTHORIZING', 'REQUIRES_PAYMENT_METHOD', 'FAILED', 'CANCELED'],
