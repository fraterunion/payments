...
export const PAYMENT_TRANSITIONS: Readonly<Record<PaymentState, readonly PaymentState[]>> = {
  CREATED: [PAYMENT_STATES.REQUIRES_PAYMENT_METHOD, PAYMENT_STATES.AUTHORIZING],
  REQUIRES_PAYMENT_METHOD: [PAYMENT_STATES.AUTHORIZING],
  AUTHORIZING: [
  ...
  REQUIRES_ACTION: [PAYMENT_STATES.AUTHORIZING, PAYMENT_STATES.FAILED],
